 ...
 * Copy Project Code: https://github.com/spatie/array-to-xml
 */
...
class ArrayToXml
{
    ...
    public function __construct(array $array = [], string $rootElement = '', bool $replaceSpacesByUnderScoresInKeyNames = true, string $xmlEncoding = null, string $xmlVersion = '1.0', array $domProperties = [], bool $xmlStandalone = null)
    {
    ...
    protected function createRootElement(string $rootElement): DOMElement
    {
